...
class ReviseFlashcardPage extends StatefulWidget {
  final String deckId;
  const ReviseFlashcardPage({super.key, required this.deckId});
  @override
  State<ReviseFlashcardPage> createState() => _ReviseFlashcardPageState();
}

class _ReviseFlashcardPageState extends State<ReviseFlashcardPage> {
